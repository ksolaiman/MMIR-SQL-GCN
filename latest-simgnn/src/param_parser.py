...
def parameter_parser():
    ...
    parser.add_argument("--training-graphs",
                        nargs="?",
                        default="./dataset/train_pairs/",
	                help="Folder with training graph pair jsons.")
    
    parser.add_argument("--validation-graphs",
                        nargs="?",
                        default="./dataset/val_pairs/",
	                help="Folder with validation graph pair jsons.")
    ...
    parser.add_argument("--load-path",
                        nargs="?",
                        default="/Users/ksolaima/SALVI/MMIR-SQL-GCN-master/latest-simgnn/data/models/4_epoch_41__with_histogram_0.008604261101413222_16-10-2022_02:08:39.pt",
	                help="Model Load folder during test.")
    parser.add_argument("--evaluate_only",
                        type=bool,
                        default=False,
	                help="Testing Only, default False")
